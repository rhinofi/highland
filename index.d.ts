...
interface HighlandStatic {
    ...
    <R>(source: (push: (err: Error | null, x?: R | Highland.Nil) => void, next: (stream?: Highland.Stream<R>) => void) => void): Highland.Stream<R>;
...
declare namespace Highland {
    ...
    interface Stream<R> extends NodeJS.EventEmitter {
        ...
        // TODO: should this be non Fasley? https://stackoverflow.com/questions/51390276/type-for-non-false-aka-truthy
        ...
        // filter<S, T>(f: (x: R extends (S | T) ? (S | T) : never) => x is S): Stream<S>;
        ...
        /**
         * Same as ratelimit, but cancels any events delayed due to rate limiting
         * when stream is destroyed.
         */
        ratelimitWithCleanup(num: number, ms: number): Stream<R>;
         ...
         * @api public
         */
        reduce<U>(iterator: (memo: U, x: R) => U, memo: U): Stream<U>;
         ...
         * @api public
         */
        scan<U>(iterator: (memo: U, x: R) => U, memo: U): Stream<U>;
         ...
         * @api public
         */
        stopOnError(f: (err: Error, push: (err: Error | null, x?: R) => void) => void): Stream<R>;
        /**
        ...
        // TODO: do we need the ones above? They are a specialization of the ones below.
        concat<U>(ys: U[]): Stream<R | U>;
        concat<U>(ys: Stream<U>): Stream<R | U>;
        ...
        merge<R, U>(this: Stream<Stream<R> | Stream<U>>): Stream<R | U>;
        merge<U>(this: Stream<U[]>): Stream<U>;
        ...
        mergeWithLimit<U>(this: Stream<U[]>, n: number): Stream<U>;
         ...
         * @api public
         */
        zipEach<U>(ys: U[][]): Stream<Array<R | U>>;
        zipEach<U>(ys: Stream<U[]>): Stream<Array<R | U>>;
        zipEach<U>(ys: Stream<U>[]): Stream<Array<R | U>>;
        zipEach<U>(ys: Stream<Stream<U>>): Stream<Array<R | U>>;
         ...
         * @api public
         */
        zipAll<T>(this: Stream<Stream<T>>): Stream<T[]>;
    ...
    type StreamElement<StreamType extends Stream<any>> =
        StreamType extends Stream<(infer ElementType)> ? ElementType : never
}
...
interface HighlandStatic {
    ...
    flatMap<R, U>(f: (x: R) => U[]): (xs: Stream<R>) => Stream<U>;
    flatMap<R, U>(f: (x: R) => U[], xs: Stream<R>): Stream<U>;

    // merge<R>(x: Stream<R>[]): Stream<R>;
    // merge<R>(x: Stream<Stream<R>>): Stream<R>;
    merge<R, U>(x: Stream<Stream<R> | Stream<U>>): Stream<R | U>;

    map<R, U>(f: (x: R) => U): (xs: Stream<R>) => Stream<U>;
    map<U, R>(f: (x: R) => U, xs: Stream<R>): Stream<U>;
    ...
    zipEach<U, R>(ys: Stream<U>[]): (xs: Stream<R>) => Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<U>[], xs: Stream<R>): Stream<Array<R | U>>;

    zipEach<U, R>(ys: U[][]): (xs: Stream<Array<R>>) => Stream<Array<R | U>>;
    zipEach<U, R>(ys: U[][], xs: Stream<Array<R>>): Stream<Array<R | U>>;

    zipEach<U, R>(ys: Stream<U[]>): (xs: Stream<Array<R>>) => Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<U[]>, xs: Stream<Array<R>>): Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<U>[]): (xs: Stream<Array<R>>) => Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<U>[], xs: Stream<Array<R>>): Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<Stream<U>>): (xs: Stream<Array<R>>) => Stream<Array<R | U>>;
    zipEach<U, R>(ys: Stream<Stream<U>>, xs: Stream<Array<R>>): Stream<Array<R | U>>;

    // zipAll<R>(xs: Stream<R>[]): Stream<R[]>;
    zipAll<R>(xs: Stream<Stream<R>>): Stream<R[]>;

    scan1<U, R>(iterator: (memo: U, x: R) => U): (xs: Stream<R>) => Stream<U>;

    scan<U, R>(iterator: (memo: U, x: R) => U): (memo: U) => (xs: Stream<R>) => Stream<U>;
    scan<U, R>(iterator: (memo: U, x: R) => U): (memo: U, xs: Stream<R>) => Stream<U>;
    scan<U, R>(iterator: (memo: U, x: R) => U, memo: U): (xs: Stream<R>) => Stream<U>;
    scan<U, R>(iterator: (memo: U, x: R) => U, memo: U, xs: Stream<R>): Stream<U>;

    compact<R>(xs: Stream<R>): Stream<NonNullable<R>>;

    concat<R, U>(ys: Stream<R>): (xs: Stream<U>) => Stream<R | U>;
    concat<R, U>(ys: Stream<R>, xs: Stream<U>): Stream<R | U>;
...
declare module 'highland' {
    ...
    export import Stream = Highland.Stream
    export import StreamElement = Highland.StreamElement
